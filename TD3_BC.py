...
class TD3_BC(object):
    ...
    def train(self, replay_buffer, two_sampler=False):
        ...
        if two_sampler:
            ...
            state, action, next_state, reward, not_done, weight, idx = replay_buffer.sample()
        ...
        abs_td = torch.abs(current_Q1-target_Q) + torch.abs(current_Q2-target_Q)
