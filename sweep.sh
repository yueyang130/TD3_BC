...
# OPER-A + noise
#hp-mr and walker-me
TAG=OPER-noise START=1 RUNS=3 TASK=gym BC_EVAL=0 RESAMPLE=False NOISE_STD=0 NOISE_TYPE=uniform bash launch_job_slurm.sh
TAG=OPER-noise START=1 RUNS=3 TASK=gym BC_EVAL=1 RESAMPLE=True NOISE_STD=0 NOISE_TYPE=uniform bash launch_job_slurm.sh
TAG=OPER-noise START=1 RUNS=3 TASK=gym BC_EVAL=1 RESAMPLE=True NOISE_STD=0.01 NOISE_TYPE=uniform bash launch_job_slurm.sh
TAG=OPER-noise START=1 RUNS=3 TASK=gym BC_EVAL=1 RESAMPLE=True NOISE_STD=0.01 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise START=1 RUNS=3 TASK=gym BC_EVAL=1 RESAMPLE=True NOISE_STD=0.1 NOISE_TYPE=uniform bash launch_job_slurm.sh
...
# noisy reward
# original TD3+BC
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=False NOISE_ELEM=reward NOISE_STD=0.1 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=False NOISE_ELEM=reward NOISE_STD=0.3 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=False NOISE_ELEM=reward NOISE_STD=1.0 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=False NOISE_ELEM=reward NOISE_STD=2.0 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=False NOISE_ELEM=reward NOISE_STD=4.0 NOISE_TYPE=normal bash launch_job_slurm.sh
# TD3+BC OPER-R
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=True NOISE_ELEM=reward NOISE_STD=0.1 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=True NOISE_ELEM=reward NOISE_STD=0.3 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=True NOISE_ELEM=reward NOISE_STD=1.0 NOISE_TYPE=normal bash launch_job_slurm.sh
# OPER-A (not correct as the adv weight is calculated by no noisy reward)
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=1 RESAMPLE=True NOISE_ELEM=reward NOISE_STD=0.1 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=1 RESAMPLE=True NOISE_ELEM=reward NOISE_STD=0.3 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-reward START=1 RUNS=1 TASK=gym BC_EVAL=1 RESAMPLE=True NOISE_ELEM=reward NOISE_STD=1.0 NOISE_TYPE=normal bash launch_job_slurm.sh

# noisy state
# original TD3+BC
TAG=OPER-noise-state START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=False NOISE_ELEM=state NOISE_STD=0.1 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-state START=1 RUNS=1 TASK=gym BC_EVAL=0 RESAMPLE=True NOISE_ELEM=state NOISE_STD=0.1 NOISE_TYPE=normal bash launch_job_slurm.sh
TAG=OPER-noise-state START=1 RUNS=1 TASK=gym BC_EVAL=1 RESAMPLE=True NOISE_ELEM=state NOISE_STD=0.1 NOISE_TYPE=normal bash launch_job_slurm.sh
...
TAG=ablate_ema START=1 RUNS=1 TASK=gym ALPHA=2.5 BC_COEF=1.0 QF_LAYER_NORM=1 PERCENT=0.5 TAU=1.0 bash launch_job_slurm.sh