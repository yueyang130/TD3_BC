...
if __name__ == "__main__":
    ...
    if args.noise_elem == 'state':
        prefix = 'noisy_state_weights'
    elif args.noise_elem == 'reward':
        prefix = 'noisy_reward_weights'
    else:
        prefix = 'weights'
    if not os.path.exists(prefix):
        os.mkdir(prefix)
    np.save(f'{prefix}/{args.env}_returns.npy', replay_buffer.returns)
